  ...
  class Engine < Rails::Engine
    ...
    initializer "templates with dynamic layouts" do |app|
      ActionView::TemplateRenderer.class_eval do
        def find_layout_with_multi_store(layout, locals, types)
          store_layout = layout
          ...
          begin
            find_layout_without_multi_store(store_layout, locals, types)
          rescue ::ActionView::MissingTemplate
            find_layout_without_multi_store(layout, locals, types)
          end
        end
